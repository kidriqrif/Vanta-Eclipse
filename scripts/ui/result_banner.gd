...
const WIN_BORDER: Color = Color(1, 0.227, 0.275, 0.9)
const NEUTRAL_BORDER: Color = Color(0.173, 0.173, 0.235, 0.8)
const WIN_HEADLINE_OUTLINE: Color = Color(0.69, 0.071, 0.157, 0.55)
